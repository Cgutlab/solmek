					...
					<div class="col s12 m12 l4">
						<div class="card z-depth-0" id="subfamilia">
							<div class="subfamilia-productos">
								...
								<a href="{{ action('SeccionProductoController@showProducto', $p->id) }}"><img style="width: 100%; height: 279px;" src="{{ asset('images/productos/'.$p->file_image) }}"></a>
							</div>
							<div class="card-content" id="image-subfamilias-card-content" style="height: 50px; width: 100%" >
