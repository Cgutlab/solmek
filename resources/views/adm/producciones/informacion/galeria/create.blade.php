@include('adm.producciones.informacion.galeria.partials.header')
				...
				<form method="POST"  enctype="multipart/form-data" action="{{action('GaleriaproduccionController@store')}}" class="col s12 m8 offset-m2 xl10 offset-xl1">
					{{ csrf_field() }}

					<div class="row">
						<h5>Crear Galeria de {!! $produccion->nombre !!}</h5>					
						<div class="divider"></div>
						<div class="file-field input-field">
						<h6>Cargue las imágenes que conformarán la galería </h6>
							<div class="btn">
								<span>Imágenes</span>
						...
						<div class="right">
							<a href="{{action('GaleriaproduccionController@index', $produccion->id )}}" class="waves-effect waves-light btn">Cancelar</a>
