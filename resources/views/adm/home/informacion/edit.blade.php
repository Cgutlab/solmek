						...
						<div class="row">
							...
							<div class="row">
								<div class="file-field input-field s6">
									...
									<div class="file-path-wrapper">
										...
										<span class="helper-text" data-error="wrong" data-success="right">Tamaño recomendado: 1400x410</span>
									</div>
								</div>
							</div>
							...
							<div class="row">
								...
								<div class="input-field col s12">
									<textarea id="titulo" name="titulo"> {{ $informacion->titulo }} </textarea>
								</div>
							</div>
							...
							<div class="row">
								...
								<div class="input-field col s12">
									<textarea id="descripcion" name="descripcion"> {{ $informacion->descripcion }} </textarea>
								</div>
