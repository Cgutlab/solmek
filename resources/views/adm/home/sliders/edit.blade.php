@include('adm.home.sliders.partials.header')
				...
				<form method="POST"  enctype="multipart/form-data" action="{{action('HomeController@updateSlider', $slider->id)}}" class="col s12 m8 offset-m2 xl10 offset-xl1">
					{{ csrf_field() }}    
					{{ method_field('PUT')}}  
					...
					<div class="row">					
						<div class="right">
							<a href="{{ action('HomeController@indexSlider') }}" class="waves-effect waves-light btn btn-color">Cancelar</a>
